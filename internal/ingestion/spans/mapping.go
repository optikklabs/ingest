...
func rowValues(r *schema.Row, dst []any) {
	...
	dst[29] = r.GetAttributes()
	dst[30] = r.GetEvents()
	dst[31] = r.GetLinks()
	dst[32] = r.GetExceptionType()
	dst[33] = r.GetExceptionMessage()
	dst[34] = r.GetExceptionStacktrace()
	dst[35] = r.GetExceptionEscaped()
	dst[36] = r.GetGenAiSystem()
	dst[37] = r.GetGenAiOperation()
	dst[38] = r.GetGenAiRequestModel()
	dst[39] = r.GetGenAiResponseModel()
	dst[40] = r.GetGenAiInputTokens()
	dst[41] = r.GetGenAiOutputTokens()
	dst[42] = r.GetIsGenAi()
	dst[43] = r.GetGenAiPrompt()
	dst[44] = r.GetGenAiCompletion()
	dst[45] = r.GetLlmUserId()
	dst[46] = r.GetLlmSessionId()
	dst[47] = r.GetLlmTags()
	dst[48] = r.GetLlmRelease()
	dst[49] = r.GetLlmPromptName()
	dst[50] = r.GetLlmPromptVersion()
	dst[51] = r.GetGenAiSpanKind()
}
